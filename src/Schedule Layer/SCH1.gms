...
execute_unload 'src/GamsOut/sch_out1.gdx' Disinput;
execute 'GDXXRW src/GamsOut/sch_out1.gdx output=src/GamsOut/Res1 par=Disinput rng=sheet1!a1';
...
execute_unload 'src/GamsOut/GDXs/GtoM' csval,cDGval,ctieval,cvdval,Ccurtval,CBatval,pnuval,lnsval,flag;
execute_unload 'src/GamsOut/GDXs/schout' PGenold,Sbatold,ptieval;
execute_unload 'src/GamsOut/GDXs/Orderlist' order;
