...
*________________________________________________________
parameter PDG(t,j);
$CALL GDXXRW.EXE data3.xlsx par=PDG rng=DGs!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD PDG
...
*________________________________________________________
parameter Nprob(x,*);
$CALL GDXXRW.EXE data3.xlsx par=Nprob rng=Dist!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD Nprob
*________________________________________________________
parameter branch(n,n,*);
$CALL GDXXRW.EXE data3.xlsx par=branch rng=Branch!a1 rdim=2 cdim=1
$GDXIN data3.gdx
$LOAD branch
...
*________________________________________________________
parameter gen(i,*);
$CALL GDXXRW.EXE data3.xlsx par=gen rng=gens!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD gen
...
*________________________________________________________
parameter price(t,*);
$CALL GDXXRW.EXE data3.xlsx par=price rng=prices!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD price
*________________________________________________________
parameter LProf(t,*);
$CALL GDXXRW.EXE data3.xlsx par=LProf rng=Load_profile!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD LProf
*________________________________________________________
parameter PfixL(n,*);
$CALL GDXXRW.EXE data3.xlsx par=PfixL rng=Loads!a1 rdim=1 cdim=1
$GDXIN data3.gdx
$LOAD PfixL
