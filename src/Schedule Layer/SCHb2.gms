...
*________________________________________________________
parameter PDG(t,j);
$CALL GDXXRW.EXE data2.xlsx par=PDG rng=DGs!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD PDG
...
*________________________________________________________
parameter Nprob(x,*);
$CALL GDXXRW.EXE data2.xlsx par=Nprob rng=Dist!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD Nprob
*________________________________________________________
parameter branch(n,n,*);
$CALL GDXXRW.EXE data2.xlsx par=branch rng=Branch!a1 rdim=2 cdim=1
$GDXIN data2.gdx
$LOAD branch
...
*________________________________________________________
parameter gen(i,*);
$CALL GDXXRW.EXE data2.xlsx par=gen rng=gens!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD gen
...
*________________________________________________________
parameter price(t,*);
$CALL GDXXRW.EXE data2.xlsx par=price rng=prices!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD price
*________________________________________________________
parameter LProf(t,*);
$CALL GDXXRW.EXE data2.xlsx par=LProf rng=Load_profile!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD LProf
*________________________________________________________
parameter PfixL(n,*);
$CALL GDXXRW.EXE data2.xlsx par=PfixL rng=Loads!a1 rdim=1 cdim=1
$GDXIN data2.gdx
$LOAD PfixL
...
display market
*________________________________________________________
parameter ak(x,x1,x2,y,y1,y2);
ak(x,x1,x2,y,y1,y2)= Nprob(x,'prob')*Nprob(x1,'prob')*Nprob(x2,'prob');
...
CBatpos                                          ,
CBatneg                                          ,
LOLEk1(t,x,x1,x2,y,y1,y2)                        ,
LOLEk2(t,x,x1,x2,y,y1,y2)                        ,
PNUEk1(t,x,x1,x2,y,y1,y2)                        ,
PNUEk2(t,x,x1,x2,y,y1,y2)                        ,
Crisk(t)                                         ,
Cmarket(t)
...
PGap(t,x,x1,x2,y,y1,y2)                         ,
LOLEk(t,x,x1,x2,y,y1,y2)                         ,
PNUEk(t,x,x1,x2,y,y1,y2)                         ,
Pmarket(t,o,k)
;
...
Spnu(n,t)=pnu.l(n,t);
Slns(n,t)=lns.l(n,t);
execute_unload 'sch_out2.gdx';
execute 'GDXXRW sch_out2.gdx par=Disinput rng=sheet1!a1';
parameter Csval,cDGval,ctieval,cvdval,Ccurtval,CBatval,pnuval,lnsval,rampup,rampdn,PGenold(t,i),Sbatold(t),flag;
Sbatold(t)=Sbat.l(t);
PGenold(t,i)=PGen.l(t,i);
rampup= sum(t,Rdgu.l(t));
rampdn= sum(t,Rdgu.l(t));
Csval=Cbat.l+sum(t,Ctie.l(t));
...
display csval,cDGval,ctieval,cvdval,CBatval,Ccurtval,pnuval,lnsval,flag;
execute_unload 'GtoM' csval,cDGval,ctieval,cvdval,Ccurtval,CBatval,pnuval,lnsval,flag;
execute_unload 'schout' PGenold,Sbatold;
